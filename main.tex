...
\begin{figure}
    ...
    \caption{\label{fig:inject-hook}Injecting te=he javascript hook into the website}
\end{figure}
...
\begin{lstlisting}[caption={XSS Code},label=php:xss-attack]
